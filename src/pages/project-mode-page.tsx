...
import AvgSessionDurationCard from "@/components/roots/project-mode/avg-session-duration-card";
...
const ProjectModePage = () => {
  ...
  return (
    <main className="page-layout-standard section-margin-standard">
      ...
      <div className="w-full grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:gap-4 gap-8">
