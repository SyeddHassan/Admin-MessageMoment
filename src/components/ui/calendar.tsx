  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-medium font-inter text-heading-color",
        nav: "space-x-1 flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-secondary-theme dark:border-none text-white p-0 opacity-100  hover:opacity-50"
        ),
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse space-y-1",
        head_row: "flex font-inter text-heading-color",
        head_cell:
        ...
        day_range_start: "day-range-start !focus:bg-secondary-theme",
        day_range_end: "day-range-end !focus:bg-secondary-theme",
        day_selected:
        ...
        day_range_middle:
          "aria-selected:bg-general-hover aria-selected:text-black dark:aria-selected:text-white",
