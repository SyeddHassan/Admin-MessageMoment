...
import { RealTimeFileTransferTableProps } from "@/interfaces/file-transfer-page-interfaces";

import { RealTimeFileTransferStatusTableData } from "@/constants/file-transfer-page-data";
...
const RealTimeFileTransferTable = ({
  ...
  >[] = [
...

    {
      ...
      cell: () => (
        <div className="w-full flex items-center gap-4">
          <Button className="w-full bg-transparent text-secondary-theme hover:text-secondary-theme-hovered underline font-inter tracking-wide text-[14px]">
            View File
          </Button>
          <Button className="w-full bg-white hover:bg-general-hover text-heading-color font-inter tracking-wide text-[14px] rounded-[6px] button-box-shadow">
            Download File
          </Button>
        </div>
      ),
                  ...
                  <TableHead
                    ...
                    className={`max-lg:!w-[180px] ${
                      header.column.id === "actions"
                        ? "rounded-[0px_6px_6px_0px] lg:w-[350px]"
