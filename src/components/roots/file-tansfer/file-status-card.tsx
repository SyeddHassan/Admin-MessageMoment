...
const FileStatusCard = () => {
  return (
    <Card
      ...
      className="w-full h-full !rounded-[0.5rem] !card-box-shadow col-span-1 order-2"
    >
      ...
      <CardContent className="pb-[5rem] h-full flex-center mx-auto">
        <DoughnutChart02
          chartData={[
            { label: "Successful", percentage: 30, color: "#64B5F6" },
            { label: "Failed", percentage: 20, color: "#FF7043" },
          ]}
        />
      </CardContent>
    </Card>
