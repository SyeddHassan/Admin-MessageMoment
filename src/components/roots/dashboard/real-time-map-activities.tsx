...
const RealTimeMapActivities = ({ selectedTab }: RealTimeMapActivitiesProps) => {
  ...
  return (
    <>
      {/* REAL TIME MAP */}
      <div className="lg:w-[66.66666667%] md:w-[55%] w-full h-full"></div>

      {/* REAL TIME MAP STATS */}
      <div className="lg:w-[calc(100%-66.66666667%)] md:w-[calc(100%-55%)] w-full lg:h-full h-[400px] flex flex-col gap-4 py-4 overflow-y-auto">
