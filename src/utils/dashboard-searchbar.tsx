...
const DashboardSearchbar = () => {
  ...
  return (
    <>
      ...
      >
        <Input
          className="w-[calc(100%-35px)] h-[30px] bg-transparent !p-0 border-none rounded-none ring-0 focus-visible:ring-0 text-[14px] font-inter tracking-wider placeholder:text-paragraph-color dark:placeholder:text-paragraph-color text-heading-color"
